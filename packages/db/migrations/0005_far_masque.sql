...
ALTER POLICY "tenant_onboarding_admin_manage" ON "tenant_onboarding" TO sneakereco_app USING ("tenant_onboarding"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin') WITH CHECK ("tenant_onboarding"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin');--> statement-breakpoint
ALTER POLICY "tenant_seo_config_admin_manage" ON "tenant_seo_config" TO sneakereco_app USING ("tenant_seo_config"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin') WITH CHECK ("tenant_seo_config"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin');--> statement-breakpoint
ALTER POLICY "tenant_seo_config_public_read" ON "tenant_seo_config" TO sneakereco_app USING ("tenant_seo_config"."tenant_id" = current_setting('app.current_tenant_id', true));--> statement-breakpoint
ALTER POLICY "tenant_theme_config_admin_manage" ON "tenant_theme_config" TO sneakereco_app USING ("tenant_theme_config"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin') WITH CHECK ("tenant_theme_config"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin');--> statement-breakpoint
ALTER POLICY "tenant_theme_config_public_read" ON "tenant_theme_config" TO sneakereco_app USING ("tenant_theme_config"."tenant_id" = current_setting('app.current_tenant_id', true));--> statement-breakpoint
ALTER POLICY "tenant_email_config_admin_manage" ON "tenant_email_config" TO sneakereco_app USING ("tenant_email_config"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin') WITH CHECK ("tenant_email_config"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin');--> statement-breakpoint
ALTER POLICY "tenant_domain_config_admin_manage" ON "tenant_domain_config" TO sneakereco_app USING ("tenant_domain_config"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin') WITH CHECK ("tenant_domain_config"."tenant_id" = current_setting('app.current_tenant_id', true) and current_setting('app.current_user_role', true) = 'admin');--> statement-breakpoint
