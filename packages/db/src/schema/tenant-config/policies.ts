...
export const tenantOnboardingAdminManagePolicy = pgPolicy(
  "tenant_onboarding_admin_manage",
  {
    for: "all",
...
export const tenantSeoConfigPublicReadPolicy = pgPolicy(
  "tenant_seo_config_public_read",
  {
    for: "select",
    to: sneakerecoAppRole,
...
export const tenantSeoConfigAdminManagePolicy = pgPolicy(
  "tenant_seo_config_admin_manage",
  {
    for: "all",
    to: sneakerecoAppRole,
...
export const tenantThemeConfigPublicReadPolicy = pgPolicy(
  "tenant_theme_config_public_read",
  {
    for: "select",
    to: sneakerecoAppRole,
...
export const tenantThemeConfigAdminManagePolicy = pgPolicy(
  "tenant_theme_config_admin_manage",
  {
    for: "all",
    to: sneakerecoAppRole,
...
export const tenantEmailConfigAdminManagePolicy = pgPolicy(
  "tenant_email_config_admin_manage",
  {
    for: "all",
    to: sneakerecoAppRole,
...
export const tenantDomainConfigAdminManagePolicy = pgPolicy(
  "tenant_domain_config_admin_manage",
  {
    for: "all",
    to: sneakerecoAppRole,
