...
import { boolean, check, integer, pgTable, text, uniqueIndex } from 'drizzle-orm/pg-core';

import { createdAtColumn, updatedAtColumn } from '../shared/columns';
import { tenants } from '../identity/tenants';

export const tenantThemeHeaderVariantValues = ['classic', 'minimal', 'centered'] as const;

export const tenantThemeHeroVariantValues = ['full_width', 'split', 'slider', 'none'] as const;

export const tenantThemeProductCardVariantValues = ['standard', 'minimal', 'detailed'] as const;

export const tenantThemeFooterVariantValues = ['standard', 'minimal', 'extended'] as const;

export const tenantThemeFilterVariantValues = ['sidebar', 'top_bar', 'drawer'] as const;

export const tenantThemeAuthVariantValues = ['simple', 'bold'] as const;
