...
export type TenantOnboardingRequestStatus =
  (typeof tenantOnboardingRequestStatusValues)[number];
...
export const tenantOnboarding = pgTable(
  "tenant_onboarding",
  {
    ...
    seoQuestionnaireCompleted: boolean("seo_questionnaire_completed")
      .notNull()
      .default(false),
    paymentIntegrationCompleted: boolean("payment_integration_completed")
      .notNull()
      .default(false),
