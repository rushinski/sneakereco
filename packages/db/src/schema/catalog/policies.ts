...
export const productVariantsPublicReadPolicy = pgPolicy(
...
export const productVariantsAdminAllPolicy = pgPolicy(
  "product_variants_admin_all",
  {
    for: "all",
    to: sneakerecoAppRole,
...
export const productImagesPublicReadPolicy = pgPolicy(
...
export const productFiltersPublicReadPolicy = pgPolicy(
  "product_filters_public_read",
  {
    for: "select",
    to: sneakerecoAppRole,
...
export const productFiltersAdminManagePolicy = pgPolicy(
  "product_filters_admin_manage",
  {
    for: "all",
    to: sneakerecoAppRole,
...
export const productFilterEntriesPublicReadPolicy = pgPolicy(
  "product_filter_entries_public_read",
  {
    for: "select",
    to: sneakerecoAppRole,
    using: sql`exists (
...
export const tagBrandsAdminManagePolicy = pgPolicy(
  "tag_brands_admin_manage",
  {
    for: "all",
    to: sneakerecoAppRole,
...
export const tagModelsAdminManagePolicy = pgPolicy(
  "tag_models_admin_manage",
  {
    for: "all",
    to: sneakerecoAppRole,
...
export const tagAliasesAdminManagePolicy = pgPolicy(
  "tag_aliases_admin_manage",
  {
    for: "all",
    to: sneakerecoAppRole,
