...
export const productVariantSizeTypeValues = ['shoe', 'clothing', 'custom', 'none'] as const;

export type ProductVariantSizeType = (typeof productVariantSizeTypeValues)[number];
...
export const productVariants = pgTable(
  'product_variants',
  {
    ...
    sizeType: text('size_type', { enum: productVariantSizeTypeValues }).notNull(),
