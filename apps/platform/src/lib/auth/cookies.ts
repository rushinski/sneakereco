...
import { adminRefreshTtlSeconds, authCookieName, sessionSigningSecret } from './config';
...
export function writeSessionCookie(response: NextResponse, session: BffSession) {
